...
def load_models():
    ...
    models['tokenizer'] = DistilBertTokenizer.from_pretrained('models/distilbert_branchC')
    models['distilbert'] = DistilBertForSequenceClassification.from_pretrained('models/distilbert_branchC')
